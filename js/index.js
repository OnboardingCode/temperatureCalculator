const tempInput = document.getElementById("textBox"); //User Temp value to read
const toFahrenheit = document.getElementById("toFahrenheit"); //temp value to from C to F.
const toFCelsius = document.getElementById("toFCelsius"); //temp value to from F to C.
